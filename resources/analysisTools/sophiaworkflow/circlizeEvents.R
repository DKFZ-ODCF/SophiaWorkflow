...
annos = annos[! ((startsWith(annos[, 1], "h") |
    startsWith(annos[, 1], "G") |
    startsWith(annos[, 1], "N") |
    startsWith(annos[, 1], "H")) & (startsWith(annos[, 4], "h") |
    startsWith(annos[, 4], "G") |
    startsWith(annos[, 4], "N") |
    startsWith(annos[, 4], "H"))),]
...
newInversions = eventTypes != "UNKNOWN_DECOY" &
    eventTypes != "TELINS" &
    eventTypes != "TRA" &
    eventTypes != "INV" &
    eventInversion == "INV"
...
smallEventSelection = ! annos$dummyChromosome &
    ! is.na(annos$eventSize) &
    annos$eventSize < 9e6
mediumEventSelection = ! annos$dummyChromosome &
    ! is.na(annos$eventSize) &
    annos$eventSize >= 9e6 &
    annos$eventSize < 18e6
largeEventSelection = is.na(annos$eventSize) |
    annos$dummyChromosome |
    annos$eventSize >= 18e6
